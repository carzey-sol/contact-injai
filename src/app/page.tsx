  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const emailResponse = await fetch('/api/send-email', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(formData), // includes subject & message
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <header className="bg-black border-b border-gray-800 shadow-md">
        <div className="container mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <a href="https://injaichannel.com" className="text-gray-400 hover:text-white">
            ← Back to Home
          </a>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/50"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/50 resize-none"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-bold py-4 px-8 rounded-lg transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-red-500/50"
              >
          ...
          <div className="mt-12 text-center">
            ...
            <a href="mailto:contact@injaichannel.com" className="text-red-500 hover:text-red-400 font-semibold">
